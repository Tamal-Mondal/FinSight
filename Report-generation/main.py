...
from tools.sec_tools_new import SECTools
...
researcher = Agent(
    ...
    backstory=
    """You have worked as a research analyst at Goldman Sachs for past 10 years, focusing on fundamental research for tech companies""",
    verbose=True,
...
task1 = Task(
    description=
    f"""please conduct a comprehensive analysis of {company}'s latest SEC 10-K filing. The analysis should include the following key points:
...
task3 = Task(
    description=
    f"""Using the insights provided by the Senior Research Analyst and Visionary, please craft an expertly styled report that is targeted towards the investor community. Make sure to also include the long-term implications insights that your co-worker, Visionary, has shared.  
    ...
    expected_output=
    f"A detailed comprehensive report on {company} that expertly presents the research done by your co-worker, Senior Research Analyst and Visionary",
    agent=writer)
